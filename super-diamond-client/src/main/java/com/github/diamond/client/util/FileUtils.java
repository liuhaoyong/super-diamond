...
public class FileUtils {
    ...
    public static void saveData(String projCode, String profile, String data) {
        try {
            String home = FileUtils.class.getResource("/").getPath();
            String dirStr = home + ".superdiamond" + File.separator + projCode + File.separator
                            + profile;
            ...
            LOGGER.info(" ##################### write config to file. path:{}", file.getPath());
    ...
    public static String readConfigFromLocal(String projCode, String profile) throws IOException {
        ...
        String home = FileUtils.class.getResource("/").getPath();
        String fileStr = home + ".superdiamond" + File.separator + projCode + File.separator
                         + profile + File.separator + "data.properties";
